...
router.put('/:id/update', employeeRefParam('id'), validate, employeeController.update);
router.post('/:id/photo', employeeRefParam('id'), validate, upload.single('photo'), employeeController.uploadPhoto);
...
router.delete('/:id', isHROrAdmin, employeeRefParam('id'), validate, employeeController.offboard);
router.post('/:id/erase', isHROrAdmin, employeeRefParam('id'), validate, employeeController.permanentlyErase);
router.put('/:id/deactivate', isHROrAdmin, employeeRefParam('id'), validate, employeeController.deactivate);
router.post('/:id/reset-self-edit-lock', isHROrAdmin, employeeRefParam('id'), validate, employeeController.resetSelfEditLock);
